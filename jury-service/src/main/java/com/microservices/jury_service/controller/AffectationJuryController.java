...
public class AffectationJuryController {
    ...
    public ResponseEntity<List<AffectationJuryDTO>> getAffectationsBySoutenance(@PathVariable Integer idSoutenance) {
    ...
    public ResponseEntity<ReponseJuryDTO> getJuryCompletBySoutenance(@PathVariable Integer idSoutenance) {
